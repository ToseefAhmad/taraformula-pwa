...
const AddressBook = props => {
    const { activeContent, classes: propClasses, toggleActiveContent, onSuccess, isShippingPhoneNumberValid } = props;
    ...
    const addAddressButton = useMemo(
        ...
        [classes.addButton, classes.addButtonIcon, classes.addText, handleAddAddress]
    );
        ...
        const addresses = customerAddresses.map((address, index) => {
            ...
            return (
                <AddressCard
                    ...
                    forceOpenAndValidate={isSelected && !isShippingPhoneNumberValid} // If phone number is invalid, open address card and validate the form
                />
            );
        });
