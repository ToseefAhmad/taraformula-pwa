...
export const usePaymentInformation = props => {
    const { onSave, checkoutError, resetShouldSubmit, setCheckoutStep, shouldSubmit, setShowLoader } = props;
    ...
    const handlePaymentError = useCallback(() => {
        ...
        setShowLoader(false);
    }, [resetShouldSubmit, setShowLoader]);
    ...
    }, [availablePaymentMethods, resetShouldSubmit, selectedPaymentMethod, setCheckoutStep, setShowLoader]);
    ...
    const handleExpiredPaymentError = useCallback(() => {
        ...
        setCheckoutStep(CHECKOUT_STEP.PAYMENT);
        setShowLoader(false);
    }, [clearPaymentDetails, cartId, resetShouldSubmit, setCheckoutStep, setShowLoader]);
