...
export const useMiniCart = props => {
    ...
    const totalQuantity = useMemo(() => {
        if (!miniCartLoading) {
            return miniCartData && miniCartData.cart && miniCartData.cart.total_quantity;
        }
    ...
    const productList = useMemo(() => {
        if (!miniCartLoading) {
            return miniCartData && miniCartData.cart && miniCartData.cart.items;
        }
    }, [miniCartData, miniCartLoading]);
