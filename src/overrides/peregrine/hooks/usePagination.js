 ...
 * @private
 */
const setQueryParam = ({ history, location, parameter, replace, value, initialValue }) => {
...
export const usePagination = (props = {}) => {
    ...
    const currentPageParam = getSearchParam(searchParam, location);
    const currentPage = parseInt(currentPageParam === '' ? initialPage : currentPageParam);
    ...
    const setCurrentPage = useCallback(
        ...
        [history, location, searchParam, initialPage]
    );
