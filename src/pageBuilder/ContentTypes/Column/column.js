...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/Column/column.module.css';
...
const Column = props => {
    ...
    return (
        <div style={dynamicStyles} ref={columnElement} className={[classes.root, ...cssClasses].join(' ')}>
            {children}
        </div>
    );
};
